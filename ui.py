...
class PersonDialog(simpledialog.Dialog): # TODO - need to be change if Person changes
    ...
    def body(self, master):
        ...
        tk.Label(master, text="Born: (dd.mm.yyyy)").grid(row=3)
        tk.Label(master, text="Death: (dd.mm.yyyy)").grid(row=4)
        ...
        self.born.grid(row=3, column=1)
        self.death.grid(row=4, column=1)
    ...
    def apply(self):
        ...
        self.result = Person(name, surname, born=born_date, death=death_date)
