...
class ZoomableImageCanvas(tk.Canvas):
    ...
    def load_image(self):
        image_path = "data/family_tree.png"
    ...
    def _apply_zoom(self):
        ...
        image = Image.open("data/family_tree.png")
...
class FamilyTreeUI:
    def __init__(self, data):
        ...
        self.add_person_button = tk.Button(self.root, text="Add Person",
                                           command=self.add_person)
        self.add_person_button.grid(row=0, column=0, pady=10)

        self.add_couple_button = tk.Button(self.root, text="Add Couple",
                                           command=self.add_couple)
        self.add_couple_button.grid(row=0, column=1, pady=10)

        self.draw_tree_button = tk.Button(self.root, text="Reload Image",
                                          command=self.reload)
        ...
        self.image_canvas = ZoomableImageCanvas(self.root,
